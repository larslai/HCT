...
<html lang="en">
	<head>
		<meta charset="utf-8">
			...
			<link href="<?=base_url()?>assets/css/competition_result.css" rel="stylesheet" >
	...
	<body>
					...
					<div class="widget stacked">
						...
						<div class="widget-content">
							...
							<div class="input-block disabled">
								<em class="red">日期</em>
								<input type="text" name="startDate" id="startDate" class="date-picker" readonly="readonly" placeholder="請選擇" value="<?php if(isset($record['startDate']) && $record['startDate'] != null){ echo $record['startDate'];} ?>"/>
							</div>
							<div class="input-block">
								<em class="red">商品名關鍵字</em>
								<input type="text" name="product_keyword" id="product_keyword" value="<?php if(isset($record['product_keyword']) && $record['product_keyword'] != null){ echo $record['product_keyword'];} ?>"/>
							</div>
							<div class="input-block">
								<em>品牌</em>
								<input type="text" name="brand" id="brand" value="<?php if(isset($record['brand']) && $record['brand'] != null){ echo $record['brand'];} ?>"/>
							</div>
							<!--
							<div class="input-block">
								<em>台灣售價</em>
								<input type="text" name="taiwan_price" id="taiwan_price" value="<?php if(isset($record['taiwan_price']) && $record['taiwan_price'] != null){ echo $record['taiwan_price'];} ?>"/>
							</div>
							<div class="input-block">
								<em>規格</em>
								<input type="text"  name="unit" id="unit" value="<?php if(isset($record['unit']) && $record['unit'] != null){ echo $record['unit'];} ?>"/>
							</div>
							-->
							...
							<div class="indicator-block price">
								<table class="table table-striped table-bordered">
									...
									<tbody  class="indicator-tbody">
										<tr>
											<td>
												淘寶<?php echo $record['product_keyword'];?>前100名
										...
										<tr>
											<td>
												<?php echo $record['cat_name'];?>/產地台灣前100名
										...
										<tr>
											<td>
												<?php echo $record['product_keyword'];?>-淘寶前100名找出<?php echo $find_product_info['find'];?>件
							...
							<div class="indicator-block price">
								<table class="table table-striped table-bordered">
									...
									<tbody  class="indicator-tbody">
										...
										<tr>
											<td>
												<?php echo $record['product_keyword'];?>-淘寶前100名找出<?php echo $find_product_info_taiwan['find'];?>件
		...
		<script type="text/javascript"  src="<?=base_url()?>assets/js/page_js/competition_result.js"></script>
		...
		<script  type="text/javascript">
			...
			var record_obj = {
				...
				product_keyword:"<?php echo $record['product_keyword']; ?>",
			};
			$(document).ready(function() {
				...
				initCompetition(radar_data,radar_data_taiwan,record_obj.cat_name ,record_obj.product_keyword);
			});
		</script>
	</body>
</html>
