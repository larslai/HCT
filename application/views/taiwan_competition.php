...
<html lang="en">
	<head>
		<meta charset="utf-8">
			...
			<link href="<?=base_url()?>assets/css/taiwan_competition.css" rel="stylesheet" >
	...
	<body>
		...
		<script type="text/javascript"  src="<?=base_url()?>assets/js/page_js/taiwan_competition.js"></script>
